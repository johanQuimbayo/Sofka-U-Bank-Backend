...
public class UsersGetTest {
    ...
    private final Integer document = 12345678;
    ...
    public void testGetUserById() {
        ...
        ResponseEntity<UserExitDTO> response = testRest.exchange("/api/v1/users/" + userId, HttpMethod.GET, httpEntity, UserExitDTO.class);
